...
def load_data():
    x, y, vocabulary, vocabulary_inv_list,x_t,y_t = data_helpers_att.load_data()
...
def load_data_test():
    x, y, vocabulary, vocabulary_inv_list = data_helpers_att.load_data_test()
