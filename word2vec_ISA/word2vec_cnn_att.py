...
hidden_dims = 100
sequence_length=300#每个文档的词数量,数据集中最大为508
attenion_head=8#attention头数
attenion_dim=128#attention的维度
...
def load_data():
    ...
    x, y, vocabulary, vocabulary_inv_list,x_t,y_t = data_helpers.load_data(sequence_length)
...
def load_data_test():
    x, y, vocabulary, vocabulary_inv_list= data_helpers.load_data_test(sequence_length)
    y = y.argmax(axis=1)
...
z=Attention_weight(attenion_head,attenion_dim)([embeddings,embeddings,embeddings])
#z=embeddings
conv_blocks = []
